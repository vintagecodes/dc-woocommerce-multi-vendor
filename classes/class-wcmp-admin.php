    ...
    public function wcmp_service_page_notice() {
        ...
        <div class="updated wcmp_admin_new_banner">
            ...
            <div class="wcmp_banner-content">
                <span class="txt"><?php _e('WC Marketplace 3.4 is almost here!', 'dc-woocommerce-multi-vendor') ?>  </span>
                <div class="rightside">        
                    <a href="https://wc-marketplace.com/" target="_blank" class="wcmp_btn_service_claim_now"><?php _e('Install WCMp 3.4', 'dc-woocommerce-multi-vendor'); ?></a>
