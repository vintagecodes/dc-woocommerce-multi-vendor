...
global $WCMp; 
?>
<div class = "wcmp-load-more-button-wrapper" ><button id="wcmp-load-more-button" class = "wcmp-load-more-button button" ><?php echo esc_html_e(' Load More ','dc-woocommerce-multi-vendor');?> </button></div>
