...
echo $email_heading . "\n\n"; 
echo sprintf(  __('Your question had been noted and answered by the vendor : ', 'dc-woocommerce-multi-vendor'), $answer ); 
echo '\n\n';
echo sprintf( __('Kindly check if the reply is up to your satisfaction : ', 'dc-woocommerce-multi-vendor'), esc_url($product->get_permalink()) ); 
echo '\n\n';
