...
<div class="wcmp-product-policies">
    ...
    <div class="wcmp-shipping-policies policy">
        ...
        <div class="wcmp_policies_description description" ><?php echo esc_html($policies['shipping_policy']); ?></div>
    </div>
    ...
    <div class="wcmp-refund-policies policy">
        ...
        <div class="wcmp_policies_description description" ><?php echo esc_html($policies['refund_policy']); ?></div>
    </div>
    ...
    <div class="wcmp-cancellation-policies policy">
        ...
        <div class="wcmp_policies_description description" ><?php echo esc_html($policies['cancellation_policy']); ?></div>
    </div>
    <?php } ?>
</div>